            ...
            <article class="app-card">
              <div class="app-card-head">
                ...
                <div class="app-actions">
                  <a class="btn secondary" href="{gmail_url}" target="_blank" rel="noopener noreferrer">EMAIL IN GMAIL</a>
                </div>
              </div>
              ...
              <section class="decision-bar">
                <div class="decision-copy"><span class="label">REVIEW ACTION</span><p>Update the applicant state here. Accepting does not automatically issue a PRT activation code yet.</p></div>
...
@media(max-width:540px){{.metrics{{grid-template-columns:1fr}}.top-actions .btn.secondary{{display:none}}.page-head h1{{font-size:38px}}.app-card-head{{align-items:flex-start}}.app-actions{{display:none}}.app-grid{{grid-template-columns:1fr}}.app-grid section{{border-right:0!important;border-bottom:1px solid var(--line)}}.app-grid section:last-child{{border-bottom:0}}.app-footer{{align-items:flex-start;flex-direction:column}}.footer-tools{{width:100%;justify-content:space-between}}.decision-actions form{{flex:1}}.decision-actions .action-btn{{width:100%}}.delete-popover{{left:0;right:auto;width:min(300px,calc(100vw - 46px))}}}}
</style>
</head>
<body>
<div class="shell">
