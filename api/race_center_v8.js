...
function ensureHome(){
  ...
  '<section class="v8-grassroots content-section" id="v8Grassroots"><div class="section-head"><div><span class="eyebrow">LOCAL + GRASSROOTS</span><h2>The local racing network</h2></div><a class="section-link" href="/race-center/tracks">Explore tracks →</a></div><div class="v8-grassroots-columns"><div><header><strong>Upcoming</strong><span>Race nights and events</span></header><div id="v8GrassrootsEvents"></div></div><div><header><strong>Tracks</strong><span>Places worth following</span></header><div id="v8GrassrootsTracks"></div></div><div><header><strong>Drivers</strong><span>People in the scene</span></header><div id="v8GrassrootsDrivers"></div></div></div></section>';
