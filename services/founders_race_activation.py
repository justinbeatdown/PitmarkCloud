...
def _hub_message(display_name: str, hub: str) -> str:
    return (
        ...
        "Your first job is simple: run one real iRacing session with PRT, use Radar plus Relative/Standings, "
        "then send one thing you liked and one thing you would change. Your hub detects the first recorded session automatically.\n\n"
