...
def visual_prompt(*, campaign: dict, headline: str, beat: str, aspect: str) -> str:
    return (
        ...
        "Unless the verified topic type is explicitly a Shopify/product campaign, do not show shirts, hoodies, "
        "hats, apparel, product mockups, ecommerce flat-lays, storefront merchandise, or clothing as the subject. "
        "For editorial/race/community topics, the main subject must be the race, track, cars, pits, atmosphere, "
        "garage, sim-racing environment, or community story described by the campaign. "
